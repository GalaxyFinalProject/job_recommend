...
function MyLoginPage() {
    ...
    let UserInfo = userShow;

    useEffect(() => {
        if (userShow.userLikeAddress != null) {
            ...
            <div className={styles.checkskillbox}>
                ...
                <div className={styles.dropdown} onClick={() => {
                    ...
                    <div className={styles.dropdownContent} style={useCountyShow == true ? { backgroundColor: '#ddd', display: 'block' } : null}>
                        <p onClick={() => { setUseCity('서울'); }}>서울</p>
                        <p onClick={() => { setUseCity('부산'); }}>부산</p>
                        <p onClick={() => { setUseCity('대구'); }}>대구</p>
                        <p onClick={() => { setUseCity('인천'); }}>인천</p>
                        <p onClick={() => { setUseCity('광주'); }}>광주</p>
                        <p onClick={() => { setUseCity('대전'); }}>대전</p>
                        <p onClick={() => { setUseCity('울산'); }}>울산</p>
                        <p onClick={() => { setUseCity('경기'); }}>경기</p>
                        <p onClick={() => { setUseCity('강원'); }}>강원</p>
                        <p onClick={() => { setUseCity('충북'); }}>충북</p>
                        <p onClick={() => { setUseCity('충남'); }}>충남</p>
                        <p onClick={() => { setUseCity('전북'); }}>전북</p>
                        <p onClick={() => { setUseCity('전남'); }}>전남</p>
                        <p onClick={() => { setUseCity('경북'); }}>경북</p>
                        <p onClick={() => { setUseCity('경남'); }}>경남</p>
                        <p onClick={() => { setUseCity('제주'); }}>제주</p>
